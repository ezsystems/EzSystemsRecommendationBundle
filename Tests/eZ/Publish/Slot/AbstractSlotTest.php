...
{
    /** @var \EzSystems\RecommendationBundle\Client\YooChooseClientInterface|\PHPUnit_Framework_MockObject_MockObject */
    protected $client;
    ...
    {
        $this->client = $this->getMockBuilder(YooChooseNotifier::class)->disableOriginalConstructor()->getMock();
